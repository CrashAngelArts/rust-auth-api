...
## temporary_password_repository.rs
...
├──  🔧 `send_expired_temporary_password_attempt_email(&self, user: &User, _attempted_password: &str) -> Result<(), ApiError> `
├──  🔧 `send_password_reset_email(&self, user: &User, token: &str) -> Result<(), ApiError> `
├──  🔧 `send_password_reset_email(&self, user: &User, token: &str) -> Result<(), ApiError> `
├──  🔧 `send_password_reset_email(&self, user: &User, token: &str) -> Result<(), ApiError> `
├──  🔧 `send_temporary_password_used_email(&self, user: &User, remaining_uses: i32) -> Result<(), ApiError> `
